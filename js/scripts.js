...
- Responsive Query Section
	...
	- add all your scripts here
		- html5.js
			// html5 shiv
		- modernizr
		- customizer.js - REMOVED - To work with slideshow
...
function dropdownOnChange ( listingSlug ) {
	...
	if (dropdown2 == null) {
		function onCatChange() {
			if ( dropdown1.options[dropdown1.selectedIndex].index > 0 ) {
				location.href = custom.templateDir+listingSlug+dropdown1.options[dropdown1.selectedIndex].value;
			}
		}		
		...
		function onCatChangea() {
			if ( dropdown1.options[dropdown1.selectedIndex].index > 0 ) {
				if ( dropdown2.options[dropdown2.selectedIndex].index > 0 ) {
					location.href = custom.templateDir+listingSlug+dropdown1.options[dropdown1.selectedIndex].value+"/"+dropdown2.options[dropdown2.selectedIndex].value;
				}
			}
		}
